...
const features = [
    ...
    },
    {
        ...
        description: 'Arma, desarma y ve lo que ocurre en tu hogar desde cualquier lugar con nuestra App.',
    },
    {
        icon: <Zap className="w-8 h-8 text-primary" />,
        title: 'Instalación sin obras',
        description: 'Sistema inalámbrico de fácil instalación. Sin cables, sin polvo y en tiempo récord.',
    },
    {
    ...
    },
    {
        ...
        title: 'Doble vía de comunicación',
        description: 'Sistema anti-inhibición que garantiza que la alarma siempre esté conectada.',
    },
];
