                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                        ...
                        >
                            ...
                            <h3 className="text-xl font-bold text-white mb-2">{t('contact_page.email_title')}</h3>
                        ...
                        >
                            ...
                            <h3 className="text-xl font-bold text-white mb-2">{t('contact_page.phone_title')}</h3>
                            <p className="text-blue-100 group-hover:text-white transition-colors">
                                937 379 317
                            </p>
                        </a>
                        ...
                        >
                            ...
                            <h3 className="text-xl font-bold text-white mb-2">{t('contact_page.whatsapp_title')}</h3>
                            <p className="text-blue-100 group-hover:text-white transition-colors">
                                937 379 317
                            </p>
                        </a>
